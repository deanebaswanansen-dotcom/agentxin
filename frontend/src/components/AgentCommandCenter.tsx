...
const TASK_PLANS: Record<AgentTask, string[]> = {
  ...
  script_plan: ['读取短剧需求', '补问关键参数', '保存结构化策划'],
  script_series_outline: ['读取锁定策划', '生成全剧总纲', '保存连续分集卡'],
  script_bible: ['读取策划与总纲', '生成人物圣经', '生成世界圣经'],
  script_episode_batch: ['展开当前五集大纲', '逐集写作与检查', '保存检查点与批次报告'],
