 ...
 *
 * NOTE (task 1.2): This file is a COPY of the canonical source at
...
export type { WriteBrief, WriteBriefItem, WriteBriefSource, WriteBriefView } from './writeBrief.js';
...
export interface NovelPlanAnswer {
  ...
  /** Human-readable labels sent with option ids to preserve the user's meaning. */
